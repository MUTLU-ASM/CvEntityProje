    ...
    <div class="main">
        ...
        <section class="slide-wrapper" id="about">
            ...
            <p class="iner mt-md-5">
                <asp:Repeater ID="rptEgitim" runat="server">
                    <ItemTemplate>
                        <%# Eval("egitim") %>
                    </ItemTemplate>
                </asp:Repeater>
        ...
        <section class="services" id="services">
            <div class="container">
                ...
                <ul class="list-unstyled mt-5">
                    <li>
                        <asp:Repeater ID="rptYetenek" runat="server">
                            <ItemTemplate>
        ...
        <div class="news" id="news">
            ...
            <p class="iner mt-md-5 text-left">
                <asp:Repeater ID="rptDeneyim" runat="server">
                    <ItemTemplate>
                        <%# Eval("isDeneyimleri") %>
                    </ItemTemplate>
                </asp:Repeater>
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        <div class="col-sm-6">
                            <asp:TextBox ID="txtAd" runat="server" placeholder="Adınız"></asp:TextBox>
                        </div>
                        <div class="col-sm-6">
