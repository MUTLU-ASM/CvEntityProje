...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="list_of_members">
        <div class="sales">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="lblTplmYtnk" runat="server" Text="Label"></asp:Label></h3>
                <p>Toplam Yetenek</p>
            </div>
        ...
        <div class="new-users">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="lblTplmMesaj" runat="server" Text="Label"></asp:Label></h3>
        ...
        <div class="orders">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="lblDrcOrtlm" runat="server" Text="Label"></asp:Label></h3>
        ...
        <div class="visitors">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="lblEnYksDrc" runat="server" Text="Label"></asp:Label></h3>
