			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<asp:TextBox ID="txtKullanici" runat="server" class="input100" placeHolder="Kullanıcı Adınız..."></asp:TextBox>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Şifreniz</span>
						<asp:TextBox ID="txtSifre" runat="server" class="input100" type="password" placeHolder="Şifreniz..."></asp:TextBox>
						<span class="focus-input100"></span>
					</div>
